...
export declare class InvitationService {
    ...
    createInvitation(serverAuthContext: unknown, options: InvitationCreateOptions): Promise<InvitationResult>;
    ...
    private resolveInvitationPrincipal;
    private auditPrincipalResolutionFailure;
...
export declare function createInvitation(serverAuthContext: unknown, options: InvitationCreateOptions): Promise<InvitationResult>;
